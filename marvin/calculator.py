...
class calc:
 ...
 def __init__(self,master):
  ...
  Button(master,text='AC',width=4,command=lambda:self.clearall()).grid(row=1, column=4)
  Button(master,text='C',width=4,command=lambda:self.clear1()).grid(row=1, column=5)
  Button(master,text="+",width=4,command=lambda:self.action('+')).grid(row=4, column=3)
  Button(master,text="x",width=4,command=lambda:self.action('x')).grid(row=2, column=3)
  Button(master,text="-",width=4,command=lambda:self.action('-')).grid(row=3, column=3)
  Button(master,text="÷",width=4,command=lambda:self.action(self.newdiv)).grid(row=1, column=3) 
  Button(master,text="%",width=4,command=lambda:self.action('%')).grid(row=4, column=2)
  ...
  Button(master,text=".",width=4,command=lambda:self.action('.')).grid(row=4, column=1)
  Button(master,text="(",width=4,command=lambda:self.action('(')).grid(row=2, column=4)
